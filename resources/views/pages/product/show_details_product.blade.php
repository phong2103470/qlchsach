    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-5 col-md-12 col-12">
         <img class="img-fluid w-100 pb-1" id="MainImg" src="../public/frontend/img/sach/{{$value->HAS_DUONGDAN}}" alt="">
            ...
            <div class="col-lg-5 col-md-12 col-12">
                <h3 class="py-4">{{$value->SACH_TEN}}</h3>
                <h2>{{number_format($value->SACH_GIA)}} đ</h2>
                <p>Số lượng: <input type="number" value="1"></p>
                <button class="buy-btn">Thêm giỏ hàng</button>

                <h4 class="mt-5 mb-3">Mô tả sách: </h4>
                <p><span class="bold">Tác giả: </span>Muneyuki Kaneshiro</p>
