                        ...
                        @foreach($edit_product as $key => $edit_value)
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="SACH_TEN" class="form-control" id="exampleInputEmail1" value="{{$edit_value->SACH_TEN}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Mô tả sách</label>
                                    <textarea style="resize: none"  rows="8" class="form-control" name="SACH_MOTA" id="ckeditor1">"{{$edit_value->SACH_MOTA}}"</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Giá</label>
                                    <input type="text" name="SACH_GIA" class="form-control" id="exampleInputEmail1" value="{{$edit_value->SACH_GIA}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Chiết khấu</label>
                                    <input type="text" name="SACH_CHIETKHAU" class="form-control" id="exampleInputEmail1" value="{{$edit_value->SACH_CHIETKHAU}}">
                                </div>
                                <!--<div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="SACH_SOTRANG" class="form-control" id="exampleInputEmail1" value="{{$edit_value->SACH_SOTRANG}}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">ISBN</label>
                                    <input type="text" name="SACH_ISBN" class="form-control" id="exampleInputEmail1" value="{{$edit_value->SACH_ISBN}}">
                                </div>
                                <div class="form-group">
